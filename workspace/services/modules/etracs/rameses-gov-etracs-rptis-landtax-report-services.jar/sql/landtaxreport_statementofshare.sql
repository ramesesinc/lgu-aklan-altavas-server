...
SELECT  
    ...
    SUM(CASE WHEN cra.revperiod='current' AND revtype='basic' THEN cra.amount + ifnull(cra.discount,0) ELSE 0.0 END )AS basiccurrentamt,     
    SUM(CASE WHEN cra.revperiod='current' AND revtype='basic' THEN ifnull(cra.discount,0) ELSE 0.0 END )AS basiccurrentdiscamt,     
